...
public class PointCP5Test
{
  ...
  public static void main(String[] args)
  {
    ...
    try // Check if the user input coordinates from the command line
    {
        //
        if (args[0].toUpperCase().charAt(0) == 'C') 
        {
            // Create Cartesian object
            point = new PointCP3mod('C', Double.valueOf(args[1]).doubleValue(), Double.valueOf(args[2]).doubleValue()); 
        }
        else
        {
            // Create Polar object
            point = new PointCP2mod('P', Double.valueOf(args[1]).doubleValue(), Double.valueOf(args[2]).doubleValue());
        }
    }
    catch(Exception e)
    {
  ...
  private static PointCP5 getInput() throws IOException
  {
    ...
    if (coordType == 'C')
    	return (new PointCP3mod('C', a, b));
    else
    	return (new PointCP2mod('P', a, b));
  }
}
