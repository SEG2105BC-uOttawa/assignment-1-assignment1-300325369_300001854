...
public class PerformanceTest{
    ...
    public static void main(String[] args){
        ...
        Integer arraySize = 10000000; //change to adjust time taken to run 
        ...
        for(int i=0;i<arraySize;i++){
			arrayX[i] = (10 - 0.0) * rX.nextDouble(); //random double between 0 and 10
			arrayY[i] = (10 - 0.0) * rY.nextDouble();
		...
		long[] pointCP1Instantiating = new long[10]; //10 iterations
        ...
        Integer iterations = 10; // change to get more accurate results
		...
		for(int j = 0; j < iterations; j++){
             ...
             * 
             */
            final long startTimeCP = System.currentTimeMillis(); //start time
                PointCPT[] point1 = new PointCPT[arraySize]; 
                for(int i=0;i<arraySize;i++){ 
                    point1[i]=new PointCPT(arrayCP[i], arrayX[i], arrayY[i]); //instantiating 10 million points
                }			
            final long endTime1 = System.currentTimeMillis(); //end time


            pointCP1Instantiating[j] = endTime1 - startTimeCP;//store time in array
        ...
        long[][] arraysToSort = {
            ...
            pointCP5Instantiating, pointCP5X, pointCP5Y, pointCP5Rho, pointCP5Theta, pointCP5Distance
        };
